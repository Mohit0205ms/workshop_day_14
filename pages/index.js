...
export default function Home() {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Mohit Singh</h2>
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Mordern Web Dev Technology</h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">I am currently learing full-stack web development. Till now, I learnrd HTML, CSS, Javascript, Bootstrap and I build some basic forntend project. </p>
    </div>
